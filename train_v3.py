"""
Train JEPA v3 entrance prediction model.

Key changes from v2:
  - Uses patch embeddings + camera pose instead of CLS token
  - Multi-image fusion per POI
  - Spatially-registered features via facade_t positional encoding
"""
import argparse
import json
import math
...
def main():
    ...
    parser.add_argument('--output-dir', default='checkpoints_v3')
