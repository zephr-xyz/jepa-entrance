...
CACHE=/home/ubuntu/dataset_cache_v3_singleedge
CHECKPOINTS=/home/ubuntu/checkpoints_v3_singleedge
...
echo "=== Step 2: Prepare v3 single-edge dataset (all samples, RTK in val) ==="
$PYTHON -u $WORK/prepare_dataset_v3_singleedge.py \
    --tiles-dir $TILES \
...
echo "=== Step 3: Train JEPA v3 single-edge ==="
